...
protected:
	...
	virtual bool on_msg(out_msg_type& msg) {return direct_send_msg(std::move(msg), true);}
#endif
	virtual bool on_msg_handle(out_msg_type& msg, bool link_down) {return direct_send_msg(std::move(msg), true);}
};
